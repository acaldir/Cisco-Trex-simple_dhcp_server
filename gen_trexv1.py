...
# ─────────────────────────────────────────────
#  TRex Config Generator + simple_icmp Updater
# ─────────────────────────────────────────────
...
# ─────────────────────────────────────────────
#  if/else bloğu üret  (simple_icmp → i, simple_ipv4/igmp → j)
# ─────────────────────────────────────────────
...
# ─────────────────────────────────────────────
#  write_simple_igmp  (loop var: j + self.mac patch)
# ─────────────────────────────────────────────
...
def _build_dhcpsrv_config_method(port_info):
    """get_dhcpsrv_config metodunu baştan üretir."""
    n = len(port_info)
    pool_lines = []
    for idx in range(n):
...
def _build_get_profile_method(port_info):
    """get_profile metodunu baştan üretir."""
    n = len(port_info)
...
# ─────────────────────────────────────────────
#  write_dhcpsrv_relay
#  Strateji: get_dhcpsrv_config ve get_profile metodlarını
#  regex ile bulup baştan üretilen versiyonlarla değiştirir.
# ─────────────────────────────────────────────
